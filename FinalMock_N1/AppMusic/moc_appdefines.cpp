...
struct qt_meta_stringdata_CLASSAppEnumsENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSAppEnumsENDCLASS = QtMocHelpers::stringData(
    "AppEnums"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSAppEnumsENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject AppEnums::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSAppEnumsENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSAppEnumsENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAppEnumsENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *AppEnums::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSAppEnumsENDCLASS.stringdata0))
